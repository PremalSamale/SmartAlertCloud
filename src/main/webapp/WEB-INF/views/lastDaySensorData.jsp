...
<body>
	<div class="sidenav">
		...
		<a href="/getRealDataSensor">Humidity Sensors</a> <a
			href="/getRealDataTempSensor">Temperature Sensor</a> <a
			href="/getLast24hoursData">last 24 hours Data</a>
	...
	<div class="main">
		...
		<form action="getRealDataSensor" method="get">
			...
			<!--  <input type="button" onclick="CreateTableFromJSON()" value="Get Data" />
    <p id="showData"></p>  -->
