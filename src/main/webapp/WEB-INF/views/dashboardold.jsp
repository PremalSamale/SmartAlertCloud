...
/*  chartConfig.put("subCaption", "In MMbbl = One Million barrels"); */
 chartConfig.put("xAxisName", "Sensor status");
 chartConfig.put("yAxisName", "No. Of Sensors ");
...
/*  chartConfig.put("caption", "Regions With Most Wildfire Alerts [2017-18]");
 ...
 chartConfig.put("numberSuffix", "k");
 chartConfig.put("theme", "fusion") ;*/
 chartConfig2.put("caption", "Sensor Type");
/*  chartConfig.put("subCaption", "In MMbbl = One Million barrels"); */
 chartConfig2.put("xAxisName", "Sensor Type");
 chartConfig2.put("yAxisName", "% Number of sensors");
 /* chartConfig.put("numberSuffix", "k"); */
 ...
 dataValuePair2.put("Humidity", 80);
 dataValuePair2.put("Temperature", 150);
 dataValuePair2.put("Smoke", 100);
...
/*  dataValuePair.put("Central Coast", 115);
 ...
 dataValuePair.put("NOrth Coast", 30); */
  ...
  for(Map.Entry conf:chartConfig2.entrySet())
  {
      jsonData2.append("'" + conf.getKey()+"':'"+conf.getValue() + "',");
  }
  ...
  {
      data2.append("{'label':'" + pair.getKey() + "','value':'" + pair.getValue() +"'},");
  }
